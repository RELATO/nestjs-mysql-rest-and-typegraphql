...
export class CommentService {
  ...
  public async showByIdea(ideaId: number, page: number = 1) {
  ...
  public async showByUser(userId: number, page: number = 1) {
    const comments = await this.commentRepository.find({
  ...
  public async create(ideaId: number, userId: number, data: CommentDTO) {
